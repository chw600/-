...
class Choosing_steps(nn.Module):
    def __init__(self, file_train, file_valid, file_test, file_label, gru_dim, data_name,
                 time_dim, timewindows, sensor_dim, steps=1, seq=1, batch_size=None,
    ...
    def forward(self):
        ...
        if(self.steps == 1):
            ...
            self.BIGRU = BIGRUTrainer(self.data_dim, self.z_dim, self.data_name, self.file_train, self.file_valid,
